...
shinyUI(navbarPage("Gallicapresse",
                   tabPanel("Graphique",fluidPage(),
                            ...
                            pageWithSidebar(headerPanel(''),
                                            ...
                                            mainPanel(
                                              conditionalPanel(condition="input.structure==2",leafletOutput("plot8")),
                                              conditionalPanel(condition="input.structure==2",fluidRow(textOutput("legende7"),align="right")),
                                              conditionalPanel(condition="input.structure==2",fluidRow(textOutput("legende8"),align="right")),
                                              conditionalPanel(condition="input.structure==2",downloadButton('downloadPlot8', 'Télécharger la carte interactive')),
                                              p(""),
